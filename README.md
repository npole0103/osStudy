...
**OS 구조**  
![image](https://user-images.githubusercontent.com/37138188/184895891-cf9f6639-911a-4662-8024-c74702c4530e.png)
...
---
![image](https://user-images.githubusercontent.com/37138188/184895978-e8b5febf-8420-4ef4-af07-44dff6bae39a.png)
...
**OS 구조**  
![image](https://user-images.githubusercontent.com/37138188/184896288-be0b42d3-c1ca-47d1-9ce1-9062f4170515.png)

Layered Approach : 각 레이어가 밑에 층에 있는 함수들 하나하나 씩 출력하게 됨

![image](https://user-images.githubusercontent.com/37138188/184896319-0ae1e70a-dcdd-4017-8c22-3fbb87c5e21f.png)

모노리딕 구조 / 간단한 구조 : 구조화 되지 않은 구조. 우리가 지양해야함.

![image](https://user-images.githubusercontent.com/37138188/184896388-01ac9a28-70aa-4d13-9664-c9825aaa2ea5.png)
...
![image](https://user-images.githubusercontent.com/37138188/184896480-e64c7af9-9f14-47f7-86cc-f4336f350855.png)
![image](https://user-images.githubusercontent.com/37138188/184896496-d06b26c0-dd11-4822-af10-e85ff245ebf3.png)
...
![image](https://user-images.githubusercontent.com/37138188/184896573-16f09ae7-0f6a-4b05-b030-2030cc7cc1fd.png)
...
---
![image](https://user-images.githubusercontent.com/37138188/184896603-550bc1af-6b2d-4bc6-952a-e89dc678cf2b.png)
...
**디스크 캐시**  
![image](https://user-images.githubusercontent.com/37138188/184896624-647e6cdc-2078-4039-84be-3589ef72fa62.png)
...
**디스크 스케줄링**  
![image](https://user-images.githubusercontent.com/37138188/184896746-7e8a3895-fb0e-434e-a61a-7176c15e4725.png)

디스크 접근 시간을 줄이는 기준 : seek time과 rotational time을 줄이는 것.
seek time이 현저히 크므로 seek time을 줄이는데 초점을 맞추고 있다.

![image](https://user-images.githubusercontent.com/37138188/184896773-dfe7330b-7832-49bd-810b-15386fa94754.png)

FCFS(FIFO방식) : FIRST COME, FIRST SERVICE 가장 안좋은 방법!!
큐로 먼저 들어온 request를 먼저 서비스 해줌.

![image](https://user-images.githubusercontent.com/37138188/184896866-1292fe6d-342c-43f6-afd8-f9bfd578493b.png)

SSTF (Shortest Seek Time First) 큐에 있는 것 중 현재 위치에서 제일 가까운 순서대로 찾아가는 것. 이 방법은 Starvation 문제가 발생.

![image](https://user-images.githubusercontent.com/37138188/184896925-533ffee2-f9a7-412a-8f58-0351452a51b1.png)

SCAN 스칸 (엘리베이터 알고리즘) : 한쪽 방향으로 쭉 서비스를 실행하면서 가고 중간 중간에 해당하는 실린더 번호를 서비스해줌. 끝 부분에 부딪히면 방향을 바꿈.

![image](https://user-images.githubusercontent.com/37138188/184897075-73fef834-7988-41aa-a61e-6639921cd011.png)

C-SCAN(SCAN과 비슷함) : 한쪽 방향으로 쭉 가는 건 동일하나 벽에 부딪히면 반대방향으로 방향을 바꾸지 않고, 반대방향 끝쪽으로 이동하여 다시 서비스를 재개함.

![image](https://user-images.githubusercontent.com/37138188/184897216-80ad6d6a-3c64-450b-83fe-b5d0fcc04110.png)
...
![image](https://user-images.githubusercontent.com/37138188/184897118-eab702c7-5e96-4bc9-aa12-3c44b169a34f.png)

C-LOOK : C-SCAN과 차이점은 끝까지 가지 않고 Request queue에 있는 제일 큰 값까지만 가고 반대 방향 끝으로 돌아오는데 돌아올 때도 Request queue에 있는 가장 작은 값으로 돌아온다. 이렇게 되면 끝까지 가게 되는 불필요한 움직임을 줄임으로써 Seek time을 줄일 수 있다.
...
**디스크 포멧팅**  
![image](https://user-images.githubusercontent.com/37138188/184897360-9331c73c-a739-444f-a4cd-0295c5108719.png)
...
![image](https://user-images.githubusercontent.com/37138188/184897681-42a616bd-db64-47b8-a2cf-bec92d0e6641.png)
...
![image](https://user-images.githubusercontent.com/37138188/184897768-b90c7658-7b8f-4440-9b4a-5a61d3d0ae41.png)
...
![image](https://user-images.githubusercontent.com/37138188/184897798-3abda33a-da65-49c2-8918-6e2537c79a88.png)
...
![image](https://user-images.githubusercontent.com/37138188/184898062-1465ed6d-b6bc-4e7b-a843-5b0e3e75b493.png)
...
![image](https://user-images.githubusercontent.com/37138188/184898112-5f436496-aa8a-4e82-9d58-c546deec5c60.png)
...
![image](https://user-images.githubusercontent.com/37138188/184898148-b116b483-f908-4b78-9761-959e220863b8.png)
...
![image](https://user-images.githubusercontent.com/37138188/184898198-c062df66-634b-4ea1-93aa-b8f03d13fcf2.png)

- Indexed allocation : 인덱스 블록에 physical block 주소를 저장함. logical block index에 physical block 주소를 저장함.
![image](https://user-images.githubusercontent.com/37138188/184898241-8bed9296-83ff-4ea9-bdaf-c8b9f18b549e.png)

Multilevel index : 1st index 블록은 -> 2nd 블록 가르킴. 2nd 블록은 physical 블록을 포인터함.
![image](https://user-images.githubusercontent.com/37138188/184898329-4549486d-5bf2-49a6-99fc-15a47021ad2a.png)
![image](https://user-images.githubusercontent.com/37138188/184898338-cd3d5167-4491-40f2-b1d2-9332ccb76707.png)
![image](https://user-images.githubusercontent.com/37138188/184898345-3dfba6e4-33a7-4529-b84d-0aab3bc07f8b.png)
![image](https://user-images.githubusercontent.com/37138188/184898381-d29f1fd3-6868-47bc-b6d0-e4ec39308549.png)
...
![image](https://user-images.githubusercontent.com/37138188/184898458-b13e6f7a-6404-4811-ba9a-5e46b1bb7bd1.png)


**Buffer Cache**

![image](https://user-images.githubusercontent.com/37138188/184898503-f6b35674-778d-4ee0-b0fc-71b479e56f1c.png)
...
![image](https://user-images.githubusercontent.com/37138188/184898688-f63cef7d-522e-4033-9f45-cc0175e07983.png)

Erase-before-write
플래쉬 메모리의 특정 page에 데이터를 저장하고 그 공간에 다시 Write를 하려면, Erase Unit 전체를 깨끗하게 만들고 난 뒤에 OverWrite를 할 수 있다.

**FTL(Flash Translation Layer)**
![image](https://user-images.githubusercontent.com/37138188/184898775-675a89b0-f597-402b-be77-28b6fa23c5e5.png)
...
![image](https://user-images.githubusercontent.com/37138188/184898863-b596bc8c-4a91-49fd-92c8-726bf0097042.png)
![image](https://user-images.githubusercontent.com/37138188/184898876-053c6b2d-7947-4ea5-96e8-cd830f84f888.png)
![image](https://user-images.githubusercontent.com/37138188/184898886-2ca6e3a5-dcea-40c2-9c07-00b48e49e829.png)
...
**Process Concept**
![image](https://user-images.githubusercontent.com/37138188/184898946-10d41575-5ec4-463e-8673-4fcced44fa1a.png)
...
![image](https://user-images.githubusercontent.com/37138188/184899051-1017f472-2169-41f7-945b-445764052f61.png)
...
![image](https://user-images.githubusercontent.com/37138188/184899171-2cd80071-303a-448e-ba18-9b481931ece1.png)
...
프로세스의 문제
![image](https://user-images.githubusercontent.com/37138188/184899487-40f59594-ef17-4df5-b508-01cdaa220fd7.png)
...
![image](https://user-images.githubusercontent.com/37138188/184899695-26a947e6-c12e-4997-8538-2fe9dc30aac1.png)
...
Solution프로세스 메모리를 할당할 때는 항상 연속적으로 DRAM상에 할당해야 함.
![image](https://user-images.githubusercontent.com/37138188/184899775-0924963b-1d83-4ffc-b6f9-708ae26f1427.png)

외부적 단편화(메모리 조각화)가 발생할 수 있음.
![image](https://user-images.githubusercontent.com/37138188/184899785-dae609fa-785b-4eb1-9236-3f67931f2b28.png)
...
**Paging**
![image](https://user-images.githubusercontent.com/37138188/184899841-0dc29949-1973-4ebb-b430-5328319f6c33.png)
...
![image](https://user-images.githubusercontent.com/37138188/184899882-7d546a2b-9e0e-49be-b3c7-293fd2e50eee.png)
...
![image](https://user-images.githubusercontent.com/37138188/184900094-3dc78289-54a0-43c4-87f5-b6a7039e9a42.png)

![image](https://user-images.githubusercontent.com/37138188/184900071-e8521168-c3d6-4720-9d9b-18c414e0479c.png)
...
![image](https://user-images.githubusercontent.com/37138188/184900200-eaa5d428-5fd9-4d89-8bd7-e40056f48d83.png)
...
**Shared Pages**
![image](https://user-images.githubusercontent.com/37138188/184900298-f845e68e-b86b-4fe3-86f2-980848352fca.png)
...
1. 보안상 문제
2. 2.오작동 막기 위해서
![image](https://user-images.githubusercontent.com/37138188/184900349-874b1fef-fa75-492b-8cf2-3a63dd4b8133.png)
![image](https://user-images.githubusercontent.com/37138188/184900361-e09a9115-9171-4a75-a427-9a7ea67519a6.png)
...
![image](https://user-images.githubusercontent.com/37138188/184900438-930f194d-bff4-44c5-b6fa-7d42824a556c.png)
...
**Demand Paging**
![image](https://user-images.githubusercontent.com/37138188/184900583-a85d1a6d-7e67-4ef3-8c2b-1201995f9577.png)
...
![image](https://user-images.githubusercontent.com/37138188/184900602-3b8480dc-86b3-47dc-bade-f32c915fcb35.png)
...
![image](https://user-images.githubusercontent.com/37138188/184900803-29c83dee-dfa7-430e-ae90-028c6d93b353.png)
...
![image](https://user-images.githubusercontent.com/37138188/184900839-54fcdfe0-7db4-4996-a05d-e4d7726ad0c0.png)
...
![image](https://user-images.githubusercontent.com/37138188/184900862-3646b3d2-a861-4e7b-8ee0-d0cedaec60cd.png)
...
페이지 교체 알고리즘 4가지
![image](https://user-images.githubusercontent.com/37138188/184900933-2d513139-61bd-421e-ba17-0aaa8ffc6b44.png)
1. FIFO Page Replacement : 메모리 상에서 가장 오랫동안 머물렀던 페이지를 Victim으로 선택해서 교체를 하겠다.

![image](https://user-images.githubusercontent.com/37138188/184900947-4c394a92-d592-48c3-922b-b0cfc56bbcaf.png)
2. Optimal Page Replacement : 미래에 가장 오랫동안 사용되지 않을 것 같은 페이지를 교체하는 것임.

![image](https://user-images.githubusercontent.com/37138188/184900980-8803c47a-1a36-4420-b305-fca1496caff6.png)
...
![image](https://user-images.githubusercontent.com/37138188/184901130-d9993584-9f13-4ade-bce9-53910f82cbb7.png)

![image](https://user-images.githubusercontent.com/37138188/184901208-a0fcfe29-f3bf-4906-a699-0f3ae6dd5b92.png)
...
![image](https://user-images.githubusercontent.com/37138188/184901239-8451c245-2969-41e6-bfcf-61dcf47b96ae.png)
...
![image](https://user-images.githubusercontent.com/37138188/184901287-8e70d8b7-52a6-4b21-bc36-dbf412d21cb1.png)
...
![image](https://user-images.githubusercontent.com/37138188/184901325-d1501695-5c02-4a6b-b848-be8e20c22886.png)
...
![image](https://user-images.githubusercontent.com/37138188/184901418-2e9d6938-6a72-4f72-881e-e675265a187d.png)
...
![image](https://user-images.githubusercontent.com/37138188/184901553-dac4ca6e-3cb0-43b7-a67c-ee0f95e899f7.png)
